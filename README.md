...
![Cyber-OS](https://img.shields.io/badge/version-2.0.0-neon_cyan) ![License](https://img.shields.io/badge/license-MIT-neon_pink)
...
CYBER-OS v2.0 features a unique retro-futuristic cyberpunk aesthetic that sets it apart from typical web applications:
